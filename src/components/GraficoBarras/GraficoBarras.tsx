...
const GraficoBarras: React.FC<GraficoBarrasProps> = ({ registro }) => {
  ...
  if (registro) {
    ...
    data = [
      ...
      [FormatarDatas.atualizadoA(dataDeRegistro), valores[0].valor, valores[1].valor, valores[2].valor],
    ];
    return (
      <SecaoGraficoBarras>
        <Chart chartType="Bar" width="350px" height="400px" data={data} className="GraficoNPKAtual" />
      </SecaoGraficoBarras>
    );
  }
};
